...
display_header() {
    ...
    echo "║                              \__/                              ║"
    echo "║                                                              ║"
    echo "║    🦅  PTERODACTYL PANEL - Powered by ANAM PROTECT  🛡️      ║"
...
deploy_protection() {
    ...
    in_func == 1 && /^\s*{/ {
        ...
        print "            throw new DisplayException(\"Lu Siapa Mau Delete User Lain Tolol? Izin Dulu Sama Id 1 Kalo Mau Delete © ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴀɴᴀᴍ - ᴘʀᴏᴛᴇᴄᴛ ᴠ" ᴠᴇʀꜱɪᴏɴ "\");";
        print "        }";
        in_func = 0; next;
    }
    { print }
    ...
    in_func == 1 && /^\s*{/ {
        ...
        print "            throw new DisplayException(\"Lu Siapa Mau Delete Server Lain Tolol? Izin Dulu Sama Id 1 Kalo Mau Delete © ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴀɴᴀᴍ - ᴘʀᴏᴛᴇᴄᴛ ᴠ" ᴠᴇʀꜱɪᴏɴ "\");";
        print "        }";
        in_func = 0; next;
    }
    { print }
