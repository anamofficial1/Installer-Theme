...
ADMIN_WHATSAPP_NUMBER="083844137458"
...
echo "║                    Developer Info                    ║"
echo "╚══════════════════════════════════════════════════════╝"
echo -e "${WHITE}OWNER  : ${ORANGE}Anam-Developer"
echo -e "${WHITE}TELEGRAM : ${ORANGE}@PraiOfficial"
echo -e "${WHITE}CHANEL : ${ORANGE}t.me/AnamchanelX"
echo -e "${RED}© 2025 Anam Developer${RESET}"
...
case "$OPTION" in
     1)
        GITHUB_TOKEN="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"
        REPO_URL="https://github.com/anamofficial1/Installer-Theme.git"
        TEMP_DIR="installer-Theme"

        git clone "https://${GITHUB_TOKEN}@github.com/anamofficial1/installer-Theme.git" "$TEMP_DIR"
     ...
     2)
        ...
        THEME_NAME="stellar"
        THEME_URL="https://github.com/anamofficial1/installer-Theme/raw/main/${THEME_NAME}.zip"
     ...
     5)
        ...
        FILE_URL="https://github.com/anamofficial1/Installer-Theme/raw/main/Slate-v1.0.zip"
        ...
        FILE_URL="https://github.com/anamofficial1/Installer-Theme/raw/main/autosuspens.zip"
    ...
    FILE_URL="https://raw.githubusercontent.com/anamofficial1/Installer-Theme/main/addons/googleanalytic/config.json"
...
;;
     9)
# Default URL gambar
DEFAULT_URL="https://files.catbox.moe/ij059e.jpg "
...
if [ $? -eq 0 ]; then
    ...
    echo "GAGAL MENGGANTI FILE! Hubungi 083844137458 untuk bantuan."
fi
;;
...
FILE_URL="https://raw.githubusercontent.com/anamofficial1/Installer-Theme/main/addons/cookies/config.json"
...
in_func == 1 && /^\s*{/ {
    ...
    print "            throw new DisplayException(\"Lu Siapa Mau Delet User Lain Tolol? Izin dulu sama ID 1 kalo mau delet. © ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴀɴᴀᴍ - ᴘʀᴏᴛᴇᴄᴛ ᴠ" ᴠᴇʀꜱɪᴏɴ "\");";
    print "        }";
    in_func = 0; next;
}
{ print }
...
in_func == 1 && /^\s*{/ {
    ...
    print "            throw new DisplayException(\"Lu Siapa Mau Delet Server Lain Tolol? Izin dulu sama ID 1 kalo mau delet. © ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴀɴᴀᴍ - ᴘʀᴏᴛᴇᴄᴛ ᴠ" ᴠᴇʀꜱɪᴏɴ "\");";
    print "        }";
    in_func = 0; next;
}
{ print }
...
20)
    ...
    for name in "${!CONTROLLERS[@]}"; do
        ...
        in_func == 1 && /^\s*{/ {
            ...
            print "        $user = Auth::user();";
            print "        if (!$user || $user->id !== " admin_id ") {";
            print "            abort(403, \"𝙰𝙽𝙰𝙼 𝙿𝚁𝙾𝚃𝙴𝙲𝚃 - 𝙰𝙺𝚂𝙴𝚂 𝙳𝙸𝚃𝙾𝙻𝙰𝙺\");";
            print "        }";
            in_func = 0; next;
        }
        { print; }
